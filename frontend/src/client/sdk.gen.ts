...
export const postApiCommentsByIdRate = <ThrowOnError extends boolean = false>(options: Options<PostApiCommentsByIdRateData, ThrowOnError>) => (options.client ?? client).post<PostApiCommentsByIdRateResponses, unknown, ThrowOnError>({
...
export const deleteApiDealershipsById = <ThrowOnError extends boolean = false>(options: Options<DeleteApiDealershipsByIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteApiDealershipsByIdResponses, unknown, ThrowOnError>({ url: '/api/dealerships/{id}', ...options });
...
export const postApiDealershipsByIdTransferOwnership = <ThrowOnError extends boolean = false>(options: Options<PostApiDealershipsByIdTransferOwnershipData, ThrowOnError>) => (options.client ?? client).post<PostApiDealershipsByIdTransferOwnershipResponses, unknown, ThrowOnError>({
...
export const getApiDealershipsByIdAnalytics = <ThrowOnError extends boolean = false>(options: Options<GetApiDealershipsByIdAnalyticsData, ThrowOnError>) => (options.client ?? client).get<GetApiDealershipsByIdAnalyticsResponses, unknown, ThrowOnError>({ url: '/api/dealerships/{id}/analytics', ...options });
...
export const getApiGeocodingAutocomplete = <ThrowOnError extends boolean = false>(options?: Options<GetApiGeocodingAutocompleteData, ThrowOnError>) => (options?.client ?? client).get<GetApiGeocodingAutocompleteResponses, unknown, ThrowOnError>({ url: '/api/geocoding/autocomplete', ...options });

export const getApiGeocodingPlaceDetails = <ThrowOnError extends boolean = false>(options?: Options<GetApiGeocodingPlaceDetailsData, ThrowOnError>) => (options?.client ?? client).get<GetApiGeocodingPlaceDetailsResponses, unknown, ThrowOnError>({ url: '/api/geocoding/place-details', ...options });

export const getApiGeocodingGeocode = <ThrowOnError extends boolean = false>(options?: Options<GetApiGeocodingGeocodeData, ThrowOnError>) => (options?.client ?? client).get<GetApiGeocodingGeocodeResponses, unknown, ThrowOnError>({ url: '/api/geocoding/geocode', ...options });

export const getApiGeocodingReverse = <ThrowOnError extends boolean = false>(options?: Options<GetApiGeocodingReverseData, ThrowOnError>) => (options?.client ?? client).get<GetApiGeocodingReverseResponses, unknown, ThrowOnError>({ url: '/api/geocoding/reverse', ...options });
