  ...
  return (
    <PageShell maxWidthClass="max-w-6xl">
      ...
      <form
        ...
        className="bg-slate-900/60 rounded-xl p-6 shadow-sm border border-slate-700/60"
      >
        {/* First Row */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-slate-700 rounded-md bg-slate-900 text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 appearance-none cursor-pointer"
            >
              {brands.map((brand) => (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <button
            ...
            className="flex items-center gap-2 text-slate-200 hover:text-blue-400 transition-colors text-sm font-medium"
          >
            <svg
              className="w-5 h-5"
              fill="none"
